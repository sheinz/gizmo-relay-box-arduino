# Generated by YCM Generator at 2017-12-04 16:10:47.235615
...
ARDUINO_PATH = '/home/yura/arduino-sdk/arduino-1.8.7'
...
flags = [
    ...
    '-DARDUINO_ARCH_AVR',
    '-I' + ARDUINO_PATH + '/hardware/tools/avr/avr/include',
    '-I' + ARDUINO_PATH + '/hardware/arduino/avr/cores/arduino',
    '-I' + ARDUINO_PATH + '/hardware/arduino/avr/variants/standard',
    '-I' + ARDUINO_PATH + '/hardware/arduino/avr/libraries/SPI/src',
    '-I./RF24',
    '-D__AVR__',
    '-D__AVR_ATmega328__',
